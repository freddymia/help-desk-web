...
export class RequestAssign extends React.Component<IRequestUpdateProps, IRequestUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
      technicianId: '0',
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : requestEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="request-name" type="text" name="name" readOnly />
                </AvGroup>
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="edimcaApp.request.description">Description</Translate>
                  </Label>
                  <AvField id="request-description" type="text" name="description" readOnly />
                </AvGroup>
                <AvGroup>
                  <Label id="priorityLabel">
                    <Translate contentKey="edimcaApp.request.priority">Priority</Translate>
                  </Label>
                  <AvField id="request-priority" type="text" name="priority" readOnly value={requestEntity.priority} />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvInput id="request-status" type="text" className="form-control" name="status" readOnly value={requestEntity.status} />
                </AvGroup>
                <AvGroup>
